...
func FromJSON(value string) gdal.Geometry {

	return gdal.CreateFromJson(value)
}

func Open(filename string, access gdal.Access) (gdal.Dataset, error) {
	return gdal.Open(filename, access)
}

// func CreateTiff(filename string) {
// 	if filename == "" {
