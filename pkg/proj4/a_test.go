...
func TestUTMToWGS84(t *testing.T) {
	lonlats, err := proj4.UTM_WGS84_ZONE(54).Inverse([]float64{374424.86565261666, 3597865.9055234734})
	if err != nil {
		t.Log(err)
	}
...
func TestUTMToWGS84_2(t *testing.T) {
	lonlats, err := proj4.UTM_WGS84_ZONE(50).Inverse([]float64{300278.079510, 3806211.646500 + 1028.256247*100})
	if err != nil {
		t.Log(err)
	}
